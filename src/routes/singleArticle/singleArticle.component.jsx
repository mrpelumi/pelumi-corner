  ...
  return (
    <div className="w-full md:w-4/5 xl:w-3/5 flex flex-col gap-3 bg-white p-3">
      ...
      <div className="rounded-md opacity-90 pb-10">
        {imgUrl ? <img className="rounded-md h-80 object-top object-fill w-full" src={imgUrl} alt="Article Image" loading="lazy" /> : <Skeleton className="h-80 w-full rounded-md" />}
      </div>
